...
<img src="bookimg/<?php echo htmlentities($result->bookImage);?>" width="100" style="border-radius:4px; margin-bottom:5px;"><br />
<a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid);?>" class="btn btn-default btn-xs"><i class="fa fa-image"></i> Change Book Image</a>
</div></div>

<div class="col-md-6">
<div class="form-group">
<label>eBook PDF (Online Reading)</label><br />
<?php if(!empty($result->bookPdf) && file_exists("bookpdf/".$result->bookPdf)) { ?>
    <span class="label label-success" style="font-size:12px; padding:4px 8px; display:inline-block;"><i class="fa fa-file-pdf-o"></i> PDF Available</span>
    <a href="bookpdf/<?php echo htmlentities($result->bookPdf);?>" target="_blank" class="btn btn-default btn-xs" style="margin-left:5px;"><i class="fa fa-eye"></i> View PDF</a>
<?php } else { ?>
    <span class="label label-warning" style="font-size:12px; padding:4px 8px; display:inline-block;"><i class="fa fa-exclamation-triangle"></i> No PDF Uploaded</span>
<?php } ?>
<br />
<a href="change-bookpdf.php?bookid=<?php echo htmlentities($result->bookid);?>" class="btn btn-primary btn-xs" style="margin-top:8px;"><i class="fa fa-upload"></i> Upload / Replace PDF</a>
</div></div>
