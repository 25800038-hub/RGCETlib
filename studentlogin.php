...
if (isset($_POST['login'])) {
    ...
    $sql = "SELECT EmailId,Password,StudentId,Status,FullName FROM tblstudents WHERE EmailId=:email and Password=:password";
...
<head>
    ...
    <meta name="description" content="RGCET Library Student Login" />
    <meta name="author" content="" />
    <title>RGCET Library Management System | Student Login</title>
