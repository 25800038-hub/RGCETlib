                            ...
                            <ul id="menu-top" class="nav navbar-nav navbar-right">
                                ...
                                <li>
                                    <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown">
                                        <i class="fa fa-user" style="font-size: 24px; vertical-align: middle;"></i> <i class="fa fa-angle-down"></i>
                                    </a>
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="my-profile.php"><i
                                                    class="fa fa-id-card"></i> View Profile</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1"
                                                href="change-password.php"><i class="fa fa-key"></i> Change Password</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <div class="navbar-collapse collapse">
                            <ul id="menu-top" class="nav navbar-nav navbar-right">
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                        <li role="presentation"><a role="menuitem" tabindex="-1"
                                                href="teacher-profile.php"><i class="fa fa-id-card"></i> View Profile</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1"
                                                href="teacher-change-password.php"><i class="fa fa-key"></i> Change
                                                Password</a></li>
                                    </ul>
                                </li>
                            </ul>
